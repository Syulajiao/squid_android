...
public class TcpProxyServer implements Runnable {
	...
	private String strPrefixSS;
 
	public TcpProxyServer(int port, String strPrefix) throws IOException {
	...
	void onAccepted(SelectionKey key){
		...
		try {
			...
			if(destAddress!=null){
				Tunnel remoteTunnel=TunnelFactory.createTunnelByConfig(destAddress, strPrefixSS, m_Selector);
